...
MicroserviÃ§o responsÃ¡vel pelo **faturamento e pagamentos**. Gerencia mÃ©todos de pagamento, processamento de transaÃ§Ãµes, faturas, cobranÃ§a recorrente, split de pagamentos, integraÃ§Ã£o com gateways, conciliaÃ§Ã£o e relatÃ³rios financeiros.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ’³ **Processamento**: IntegraÃ§Ã£o com gateways
- ðŸ§¾ **Faturas**: GeraÃ§Ã£o e gestÃ£o de invoices
- ðŸ”„ **RecorrÃªncia**: CobranÃ§as automÃ¡ticas
- ðŸ’° **Split**: DivisÃ£o de pagamentos
- ðŸ¦ **ConciliaÃ§Ã£o**: ReconciliaÃ§Ã£o bancÃ¡ria
- ðŸ“Š **RelatÃ³rios**: Dashboards financeiros
- ðŸ’¸ **Reembolsos**: GestÃ£o de estornos
- ðŸ”’ **SeguranÃ§a**: PCI DSS compliance
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Billing;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
- **Local**: http://localhost:5006/swagger
...
curl -X GET "http://localhost:5006/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Billing --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Billing.ToLower() registry.azurecr.io/pam/PAM_MS_Billing.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Billing.ToLower():latest
`
...
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Billing/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Billing)**
